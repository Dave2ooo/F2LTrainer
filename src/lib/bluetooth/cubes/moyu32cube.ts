/**
 * MoYu 3x3 AI Cube implementation
...
function getKeyAndIv(value: number[]): [number[], number[]] {
...
function sendRequest(req: number[]) {
	if (!_chrct_write) {
...
function sendSimpleRequest(opcode: number) {
...
function updateMoveTimes(locTime: number) {
