...
<h2 class={`group ${className}`}>
	<button
		...
		class={`flex w-full cursor-pointer items-center justify-start border-b border-gray-200 px-2 py-2 text-left font-medium text-theme-text transition-colors group-first:rounded-t-xl group-first:border-t hover:bg-gray-100 focus:outline-none focus-visible:ring-4 focus-visible:ring-gray-300 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus-visible:ring-gray-600 ${
